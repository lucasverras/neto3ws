...
export const config = {
  ...
  matcher: [
    "/((?!_next|acervo/|images/|video/|fonts/|icon.png|apple-icon.png|favicon\\.ico|favicon-.*\\.png|icon-.*\\.png|apple-touch-icon\\.png|site\\.webmanifest|sitemap.xml|robots.txt|llms.txt).*)",
  ],
};
