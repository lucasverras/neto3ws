...
export const pt = {
  ...
  origin: {
    label: "Origem",
    heading: "Três Wanderleys. Três gerações construindo a mesma história.",
    paragraph1:
    ...
    paragraph3:
      "O nome carrega os três Wanderleys. E a forma de trabalhar também carrega algo de cada geração: experiência, confiança e evolução.",
